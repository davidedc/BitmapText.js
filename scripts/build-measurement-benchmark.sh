...
# Build script for Node.js measurement performance benchmarks
# Builds both unbundled and bundled versions

set -e  # Exit on any error

echo "[$(date '+%Y-%m-%d %H:%M:%S')] Building Measurement Benchmarks..."
...
UNBUNDLED_OUTPUT="$OUTPUT_DIR/measurement-benchmark-unbundled.bundle.js"
BUNDLED_OUTPUT="$OUTPUT_DIR/measurement-benchmark-bundled.js"
...
# Concatenate all files (same order as rendering benchmark)
...
echo "// ============================================================================" >> "$UNBUNDLED_OUTPUT"
echo "// CHARACTER SETS CONFIGURATION" >> "$UNBUNDLED_OUTPUT"
echo "// ============================================================================" >> "$UNBUNDLED_OUTPUT"
cat "$SRC_DIR/runtime/CharacterSets.js" >> "$UNBUNDLED_OUTPUT"
echo "" >> "$UNBUNDLED_OUTPUT"
...
echo "// ============================================================================" >> "$UNBUNDLED_OUTPUT"
echo "// POSITIONING BUNDLE STORE" >> "$UNBUNDLED_OUTPUT"
echo "// ============================================================================" >> "$UNBUNDLED_OUTPUT"
cat "$SRC_DIR/runtime/PositioningBundleStore.js" >> "$UNBUNDLED_OUTPUT"
echo "" >> "$UNBUNDLED_OUTPUT"
...
echo "// ============================================================================" >> "$UNBUNDLED_OUTPUT"
cat "$SRC_DIR/platform/FontLoaderNode.js" >> "$UNBUNDLED_OUTPUT"
echo "" >> "$UNBUNDLED_OUTPUT"
...
echo "// ============================================================================" >> "$UNBUNDLED_OUTPUT"
tail -n +2 "$SRC_DIR/node/measurement-benchmark-main.js" >> "$UNBUNDLED_OUTPUT"
...
echo "// ============================================================================" >> "$BUNDLED_OUTPUT"
echo "" >> "$BUNDLED_OUTPUT"
tail -n +23 "$SRC_DIR/node/measurement-benchmark-bundled-main.js" | \
  grep -v "const { Canvas }" | \
...
echo "[$(date '+%Y-%m-%d %H:%M:%S')] All measurement benchmarks built successfully! ✅"
echo ""
echo "Output files:"
...
echo "  ./perf/node/run-measurement-benchmarks.sh"
