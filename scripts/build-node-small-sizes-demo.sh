...
# Build script for Node.js small-sizes-demo
# Concatenates existing source files to build the standalone small sizes demo

set -e  # Exit on any error

echo "[$(date '+%Y-%m-%d %H:%M:%S')] Building Node.js small-sizes demo..."
...
OUTPUT_FILE="$OUTPUT_DIR/small-sizes.bundle.js"
...
FILES_TO_CHECK=(
  ...
  "$SRC_DIR/node/small-sizes-main.js"
)
 ...
 *
 * BitmapText.js Node.js Demo - Small Font Sizes Interpolation
 *
 * This file is automatically generated by concatenating multiple source files.
 *
 * Source files:
 *   - src/node/small-sizes-main.js (main demo logic)
 *   - src/runtime/BitmapText.js (core rendering)
 *   - src/runtime/InterpolatedFontMetrics.js (small size interpolation)
 ...
 *   2. Run: ./scripts/build-node-small-sizes-demo.sh
 *
 * Usage:
 *   node examples/node/dist/small-sizes.bundle.js
 *
 * Output:
 *   small-sizes-output.png (in current directory)
 *
 * Generated by: scripts/build-node-small-sizes-demo.sh
 * Bundle size: ~207KB standalone executable with no dependencies
 */
...
# Concatenate main execution (using small-sizes version)
echo "// ============================================================================" >> "$OUTPUT_FILE"
echo "// MAIN EXECUTION - Node.js Small Sizes Demo" >> "$OUTPUT_FILE"
echo "// ============================================================================" >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
tail -n +2 "$SRC_DIR/node/small-sizes-main.js" >> "$OUTPUT_FILE"
...
echo "Size: $FILE_SIZE bytes ($(echo "scale=2; $FILE_SIZE/1024" | bc) KB)"
echo "Lines: $LINE_COUNT"
echo ""
echo "To run the small sizes demo:"
echo "  cd $PROJECT_ROOT"
echo "  node examples/node/dist/small-sizes.bundle.js"
echo ""
echo "To rebuild:"
echo "  ./scripts/build-node-small-sizes-demo.sh"
echo ""
