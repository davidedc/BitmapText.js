...
class FontMetricsStore {
  constructor() {
    ...
    this._fontMetrics = new Map(); // fontProperties.key → FontMetrics instance
  }
   ...
   */
  getFontMetrics(fontProperties) {
    return this._fontMetrics.get(fontProperties.key);
  }
   ...
   */
  setFontMetrics(fontProperties, fontMetrics) {
    this._fontMetrics.set(fontProperties.key, fontMetrics);
  }
   ...
   */
  hasFontMetrics(fontProperties) {
    return this._fontMetrics.has(fontProperties.key);
  }
   ...
   */
  deleteFontMetrics(fontProperties) {
    return this._fontMetrics.delete(fontProperties.key);
  }
   ...
   */
  getAvailableFonts() {
    return Array.from(this._fontMetrics.keys());
  }
