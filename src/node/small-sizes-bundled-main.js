 ...
 * to demonstrate small font size interpolation (sizes < 9px).
 *
 * User provides:
...
async function main() {
  try {
    ...
    console.error('3. Ensure font metrics exist for size 9px: metrics-density-1-0-Arial-style-normal-weight-normal-size-9-0.js');
